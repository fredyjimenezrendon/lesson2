...
public class Main
{
	...
	protected Measure<String> makeItReadable(Measure<BigDecimal> measure)
	{
		...
		setMeasure(measure::getHumidity, result::setHumidity, "unit");
	...
	public void setMeasure(Supplier<BigDecimal> getValue, Consumer<String> setResult, String unit){
		setResult.accept(makeItReadable(getValue.get(), unit));
	}
